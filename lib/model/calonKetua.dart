...
class CalonKetua {
  ...
  static Future<List<CalonKetua>> getKetua() async {
    String apiUrl = 'https://api-evoting.000webhostapp.com/getketua.php';
  ...
  static postKetua({required String id, required String idCalon}) async {
    String apiUrl = 'https://api-evoting.000webhostapp.com/postketua.php';
  ...
  static Future<CalonKetua> isVoting(String id) async {
    String apiUrl = "https://api-evoting.000webhostapp.com/isvotingketua.php";
